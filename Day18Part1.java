...
public class Day18Part1 {
    ...
    private static Set<Point> buildBoundary(List<String> digPlan) {
    ...
    private static long calculateArea(Set<Point> points) {
        minX--;
        minY--;
        maxX++;
        maxY++;
        ...
        long boundaryArea = (long) (Math.abs(minX - maxX) + 1) * (Math.abs(minY - maxY) + 1);
